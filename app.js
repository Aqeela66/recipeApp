...
fetch(`${base}/complexSearch?apiKey=${key}&query=${query}`)
    .then(function(response) {
        ...
        let image6 = recipesArray.results[6].image;
        document.getElementsByClassName("recipe-card")[0].innerHTML = recipesArray.results[1].title;
        document.getElementsByClassName("recipe-card")[0].style.backgroundImage = `url(${image1})`;

        document.getElementsByClassName("recipe-card")[1].innerHTML = recipesArray.results[2].title;
        document.getElementsByClassName("recipe-card")[1].style.backgroundImage = `url(${image2})`;

        document.getElementsByClassName("recipe-card")[2].innerHTML = recipesArray.results[3].title;
        document.getElementsByClassName("recipe-card")[2].style.backgroundImage = `url(${image3})`;

        document.getElementsByClassName("recipe-card")[3].innerHTML = recipesArray.results[4].title;
        document.getElementsByClassName("recipe-card")[3].style.backgroundImage = `url(${image4})`;

        document.getElementsByClassName("recipe-card")[4].innerHTML = recipesArray.results[5].title;
        document.getElementsByClassName("recipe-card")[4].style.backgroundImage = `url(${image5})`;

        document.getElementsByClassName("recipe-card")[5].innerHTML = recipesArray.results[6].title;
